...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-[2px] border border-transparent bg-clip-padding font-sans text-[0.75rem] font-semibold tracking-[0.08em] uppercase leading-none pt-[1px] whitespace-nowrap transition-all outline-none select-none focus-visible:border-[#718f80] focus-visible:ring-3 focus-visible:ring-[#718f80]/20 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
